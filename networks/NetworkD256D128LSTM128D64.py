...
class NetworkD256D128LSTM128D64(nn.Module):

    def __init__(self, input_dim, output_dim):
        super().__init__()
        self.rnn_hidden_size = 64
        self.rnn_input_size = 128
        self.hid_1 = nn.Linear(input_dim, 256)
        self.hid_2 = nn.Linear(256, self.rnn_input_size)
        self.lstm = nn.LSTMCell(self.rnn_input_size, 128)
        self.hid_3 = nn.Linear(128, self.rnn_hidden_size)
